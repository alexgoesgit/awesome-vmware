...
- [Kubermatic Virtualization](https://www.kubermatic.com/products/kubermatic-virtualization/) - Provides a unified platform that enables organizations to seamlessly orchestrate and manage both traditional virtual machines (VMs) and modern containerized applications. [[docs](https://docs.kubermatic.com/kubermatic-virtualization/main/)]
...
- [Softiron HyperCloud](https://softiron.com/hypercloud/) - Delivers a on-premises or private cloud by supplying the entire stack from hardware provisioning to tenancy management
